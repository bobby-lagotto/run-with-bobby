...
Apple ha respinto **1.5.3 (12)** su iPad Air 11-inch: il coach ripeteva la stessa domanda e non creava un piano (né si poteva bypassare la chat) quando non c’erano modello locale né API key. Nuova versione **1.5.5 (13)**.

Da questo repository non si può cliccare Submit: i passi si fanno in App Store Connect.

1. Archivia e carica la build **13** (versione 1.5.5).
2. Crea/seleziona la versione **1.5.5** e collega la build **13**.
