...
- Fix selezione modelli locali in Impostazioni AI: il tap sulla riga ora aggiorna correttamente il modello attivo.
- Tap su un modello non scaricato avvia il download direttamente dalla riga.
- Correzione persistenza dei modelli scaricati tra un avvio e l'altro dell'app.
